...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--config', type=str, default='config/test_2D_IR_Elastic.json',help='JSON file for configuration')
