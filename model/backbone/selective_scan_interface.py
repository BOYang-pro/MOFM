...
class SelectiveScanFnv1(torch.autograd.Function):
...
def selective_scan_fn_v1(u, delta, A, B, C, D=None, delta_bias=None, delta_softplus=False, nrows=1):
    ...
    not considered in the backward pass.
    """
    return SelectiveScanFnv1.apply(u, delta, A, B, C, D, delta_bias, delta_softplus, nrows)


def selective_scan_ref_v1(u, delta, A, B, C, D=None, delta_bias=None, delta_softplus=False):
    """
    u: r(B D L)
    delta: r(B D L)
    A: c(D N) or r(D N)
