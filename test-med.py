...
if __name__ == "__main__":
    ...
    resume_path=os.path.join('./checkpoint/Med_elastic.pth')
    opt['path']['resume_state']=resume_path
    for dataset_name in ["CT-MRI","PET-MRI"]:
        ...
        with torch.no_grad():
            for img_name in tqdm(os.listdir(os.path.join(test_folder, "ir"))):
                ...
                #result
                Reg_result,Fusion_result=Mamba.Reg_Fus_net.Val_Fusion_med(vi,ir_warp,device)   
